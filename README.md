...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--akhftw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--akhftw.containers.anotherwebservice.com/
...
```
git clone git@github.com:egosinenomine/container--akhftw.git
cd container--akhftw
```
...
```
docker attach container--akhftw
```
